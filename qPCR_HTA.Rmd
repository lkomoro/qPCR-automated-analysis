...
```{r test, echo=TRUE}
test.data$geomean<-(test.data$x1*test.data$x2*test.data$x3)^(1/3)
```
*note need to change this depending on how many ref genes you have (i.e., if have 2, change exponent to 1/2)*
